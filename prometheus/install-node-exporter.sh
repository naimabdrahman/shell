## install node exporter centos 8
## version : node_exporter-1.7
...
wget "https://github.com/prometheus/node_exporter/releases/download/v0.18.1/node_exporter-0.18.1.linux-amd64.tar.gz" #old
...
#tar -zxvf /root/dl/node_exporter-0.18.1.linux-amd64.tar.gz #old
tar -zxvf /root/dl/node_exporter-1.7.0.linux-amd64.tar.gz
sleep 2
...
echo -e "ExecStart=/root/node_exporter/node_exporter-1.7.0.linux-amd64/node_exporter" >> /etc/systemd/system/node_exporter.service
echo -e "" >> /etc/systemd/system/node_exporter.service
